        ...
        >
          {loding ? (
            ...
            categories.map((category) => (
              <div
                className="gap-5 bg-gray-300 rounded-xl relative"
                key={category.id}
              >
                <img
                ...
                <div className="absolute w-full items-center flex justify-between  px-5 z-10 bottom-4">
                  ...
                  <div className="flex gap-4">
                    <button className="rounded-sm cursor-pointer hover:bg-transparent border-2  border-blue-600 text text-white  bg-blue-600 px-3 py-[1px] ">
                      Edit
                    </button>
                    <button className="rounded-sm cursor-pointer hover:bg-transparent border-2 border-red-600  text text-white bg-red-600 px-3 py-[1px] ">
                      Delete
                    </button>
                  </div>
                </div>
